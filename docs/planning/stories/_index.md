# Stories Index — Suivi de progression

> Mettre à jour le status de chaque story à chaque fin de session.
> **Post-audit :** Toutes les stories sont fullstack (backend API + frontend UI). Voir `archive/AUDIT-BACKEND.md` et `archive/AUDIT-FRONTEND.md`.
...
| # | Story | Scope | Status | Fichier |
|:---|:---|:---|:---|:---|
| v1-01 | Stock Management | Backend + Frontend | `todo` | [v1/v1-01-stock.md](./v1/v1-01-stock.md) |
| v1-02 | Stock Alerts UI | Backend + Frontend | `todo` | [v1/v1-02-stock-alerts.md](./v1/v1-02-stock-alerts.md) |
| v1-03 | Asset Tracking | Backend + Frontend | `todo` | [v1/v1-03-assets.md](./v1/v1-03-assets.md) |
| v1-04 | Financial Reporting | Backend + Frontend | `todo` | [v1/v1-04-financials.md](./v1/v1-04-financials.md) |
| v1-05 | Task Fusion Engine UI | Backend + Frontend | `todo` | [v1/v1-05-fusion-ui.md](./v1/v1-05-fusion-ui.md) |
| v1-06 | Proxy Task Management | Backend + Frontend | `todo` | [v1/v1-06-proxy.md](./v1/v1-06-proxy.md) |
| v1-07 | Task Conflict Detection UI | Backend + Frontend | `todo` | [v1/v1-07-conflicts.md](./v1/v1-07-conflicts.md) |
| v1-08 | Incident Reporting (complet) | Backend + Frontend | `todo` | [v1/v1-08-incidents.md](./v1/v1-08-incidents.md) |
| v1-09 | Calendar Multi-Views | Backend + Frontend | `todo` | [v1/v1-09-calendar-multi.md](./v1/v1-09-calendar-multi.md) |
| v1-10 | Dashboard KPIs avancés | Backend + Frontend | `todo` | [v1/v1-10-dashboard-advanced.md](./v1/v1-10-dashboard-advanced.md) |
| v1-11 | Auto-Rules Management | Backend + Frontend | `todo` | [v1/v1-11-auto-rules.md](./v1/v1-11-auto-rules.md) |
| v1-12 | Revenue Entry UI | Backend + Frontend | `todo` | [v1/v1-12-revenue.md](./v1/v1-12-revenue.md) |

## Phase 3 — V1.1+ (voir V1-ROADMAP.md)

Stories V1.1+ ne seront pas créées en fichiers individuels tant que la Phase 2 n'est pas terminée.
...
- `blocked` — Bloquée (indiquer la raison dans le fichier story)
